  ...
  return (
    <>
      <div className="my-4 mb-14">
        ...
        >
          <button className="bg-denim-600 hover:bg-denim-500 shadow-md shadow-denim-400 text-white rounded-lg px-4 py-2 min-w-[300px] transition-all duration-500 hover:scale-105">
            View More
          </button>
        </Link>
      </div>
